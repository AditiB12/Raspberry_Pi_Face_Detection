...
#### Explanation of euclidean distance and Cosine similarity copied from the University of Illinois Urbana Champaign's ECE 479: IoT Systems curriculum: Euclidean Distance vs. Cosine Similarity: While Euclidean distance is common, Cosine Similarity is the standard for comparing embeddings because it measures the
angle between vectors, ignoring lighting-induced magnitude changes.
